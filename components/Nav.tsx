          ...
          <div className="flex justify-between items-center   py-6 sm:justify-between sm:space-x-10">
            ...
            <div className=" md:hidden">
                ...
                <div
                  ...
                  >
                    <div className="rounded-lg shadow-lg  ring-1 h-full ring-black ring-opacity-5 bg-[#161B21] border-[1px] border-red-100/20 text-white divide-y-2 divide-gray-50">
